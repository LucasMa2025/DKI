"""
BM25 Search Mixin - 实验系统版本

从 demo/store/bm25_mixin.py 复制, 修改导入路径。

Author: AGI Demo Project
Version: 1.0.0 (forked from demo/store/bm25_mixin.py 3.0.0)
"""
...
from dki.experiment.store.models import DemoMessage
